    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="mt-16 w-full flex flex-col-reverse gap-4 lg:flex-row items-center px-10 md:px-16">
        <div className="flex flex-col items-start justify-start space-y-6 w-full lg:w-1/2">
          ...
          <p className="font-outfit text-lg w-full lg:w-[80%] text-gray-700">Simplify the way you manage work. taskFlow gives you a clear overview of your projects, deadlines, and priorities so your team stays focused and productive.</p>
